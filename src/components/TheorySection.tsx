...
interface TheorySectionProps {
  ...
  /** When false, theory is always visible (no collapse control). Default true. */
  collapsible?: boolean;
}
...
export default function TheorySection({
  ...
  const inner = (
    <div className="w-full max-w-full space-y-4 overflow-hidden rounded-xl border border-zinc-200/80 bg-white p-4 shadow-sm sm:rounded-2xl sm:p-5 md:p-6 lg:p-7">
